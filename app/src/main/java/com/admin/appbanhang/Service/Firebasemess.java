package com.admin.appbanhang.Service;
...
import com.admin.appbanhang.activity.MainActivity;
...
public class Firebasemess extends FirebaseMessagingService {
    ...
    private void showNotification(String title, String body) {
        ...
        if(Build.VERSION.SDK_INT >=Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(channelId,"app",NotificationManager.IMPORTANCE_HIGH);
    ...
    private RemoteViews customView(String title, String body){
        ...
        remoteViews.setImageViewResource(R.id.imgnoti,R.drawable.ic_notifi);
        return remoteViews;
