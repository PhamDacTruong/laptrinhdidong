package com.admin.appbanhang.adapter;
...
import com.admin.appbanhang.Interface.ItemClickListener;
import com.admin.appbanhang.R;
import com.admin.appbanhang.activity.ChiTietActivity;
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int pos, boolean isLongClick) {
                if(!isLongClick){
                    ...
                    EventBus.getDefault().postSticky(new XoaSua(sanPhamMoi));
                }
            }
        });
    }
